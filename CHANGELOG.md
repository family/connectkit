...
- Adds support for `viem`'s [SIWE](https://viem.sh/docs/siwe/actions/verifySiweMessage) in `connectkit-next-siwe`.

## Deprecated

- Removes dependency `ethers` from `connectkit-next-siwe`.
