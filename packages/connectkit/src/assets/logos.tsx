...
export const XDEFI = ({ background = false, ...props }) => (
  <svg 
    {...props}
    width="48"
    height="48"
  ...
  >
  <mask 
    id="mask0_1_9" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0" y="0" width="48" height="48"
  >
  <path 
    d="M48 0H0V48H48V0Z" fill="white"
  />
  </mask>
  <g 
    mask="url(#mask0_1_9)"
  >
  <path 
    d="M38.25 0H9.75C4.36522 0 0 4.36522 0 9.75V38.25C0 43.6348 4.36522 48 9.75 48H38.25C43.6348 48 48 43.6348 48 38.25V9.75C48 4.36522 43.6348 0 38.25 0Z" fill="#335DE5"
  />
  <path 
    d="M43.4473 22.6169C43.1967 19.2314 42.0544 15.9692 40.1332 13.1504C38.2124 10.3321 35.579 8.05483 32.4918 6.54337C29.405 5.03231 25.9717 4.33879 22.53 4.53153C19.088 4.72426 15.7565 5.79614 12.8636 7.64251C9.97069 9.48844 7.61619 12.045 6.03174 15.0596L5.9565 15.2116C5.45598 16.2306 5.11761 17.3198 4.95385 18.4403C4.48552 21.752 5.21175 24.6994 7.10883 26.9688C9.18374 29.4502 12.5618 30.9262 16.6139 31.12C21.5467 31.3645 26.4514 30.0407 29.932 27.6054L31.9957 28.8143C30.0242 30.496 25.466 33.5244 17.9167 33.9383C9.44241 34.3997 5.91023 31.6876 5.87723 31.6599L5.28297 32.3815L4.5 33.3068C4.65007 33.4312 8.03705 36.1252 15.9915 36.1252C16.6425 36.1252 17.3265 36.1252 18.0386 36.0699C27.1756 35.5679 32.2009 31.6477 33.9592 29.9652L35.6852 30.9972C34.5245 32.4992 33.0961 33.7812 31.4691 34.7796C25.7347 38.4233 18.4414 38.8938 13.3352 38.6402L13.2277 40.7654C14.0852 40.8068 14.9095 40.8254 15.7106 40.8254C30.0982 40.8254 35.9186 34.3799 37.5505 32.0683L38.8992 32.8582C37.6064 35.0253 35.8493 36.8969 33.7435 38.338C31.2219 40.0636 28.2877 41.1129 25.2294 41.3827L25.4169 43.5C28.8505 43.1987 32.1457 42.0221 34.9771 40.0857C37.8084 38.1493 40.0789 35.5201 41.564 32.4569C43.0486 29.3933 43.6984 26.0023 43.4473 22.6169ZM35.1384 22.9443C34.1837 22.9443 33.4095 22.1825 33.4095 21.2424C33.4095 20.3025 34.1832 19.5406 35.1384 19.5406C36.0928 19.5406 36.8669 20.3025 36.8669 21.2424C36.8669 22.1825 36.0932 22.9443 35.1384 22.9443Z" fill="#ECECEC"
  />
  </g>
  </g>
  <defs>
