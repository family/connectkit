...
- If you want to run this example locally have a look at the instructions in the [ConnectKit README](https://github.com/openfort-xyz/openfort-kit#running-examples-locally)
