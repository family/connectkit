...
const Spinner = () => {
  ...
  return (
    <svg aria-hidden="true" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <defs>
        <linearGradient id={gradientId} x1="2" y1="19.4884" x2="16.8752" y2="33.7485" gradientUnits="userSpaceOnUse">
...
const ChainSelectList = ({ variant }: { variant?: 'primary' | 'secondary' }) => {
  ...
  const isError = error && 'code' in error && (error as any).code === 4902 // Wallet cannot switch networks
