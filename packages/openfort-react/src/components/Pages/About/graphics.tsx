...
const Compass = () => {
  ...
  return (
    <svg aria-hidden="true" width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <defs>
        <linearGradient id={gradientId} x1="17" y1="0" x2="17" y2="34" gradientUnits="userSpaceOnUse">
...
const Wallet = ({ inverted = false }) => {
  const gradientId = useId()
  return (
    <svg aria-hidden="true" width="58" height="50" viewBox="0 0 58 50" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
...
const Receive = (
  <svg aria-hidden="true" width="38" height="44" viewBox="0 0 38 44" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      fillRule="evenodd"
      clipRule="evenodd"
...
const VitalikAddress = (
  <svg aria-hidden="true" width="131" height="14" viewBox="0 0 131 14" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
