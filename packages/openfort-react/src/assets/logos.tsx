...
export const Unstoppable = ({ ..._props }) => (
  <svg
    aria-hidden="true"
    {...props}
    width="88"
...
export const InfinityWallet = ({ ..._props }) => (
  <svg
    aria-hidden="true"
    {...props}
    version="1.1"
...
export const OtherWallets = ({ ..._props }) => {
