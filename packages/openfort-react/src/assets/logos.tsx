...
const MetaMask = ({ background = false, ...props }) => (
  <svg
    {...props}
    style={
      background
...
const Stripe = ({ ...props }) => (
  <svg {...props} width="360" height="151" viewBox="0 0 360 151" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path fillRule="evenodd" clipRule="evenodd" d="M169.8 26.5L194.9 21.1V0.800049L169.8 6.10005V26.5Z" fill="currentColor"/>
    <path d="M194.9 34.1001H169.8V121.6H194.9V34.1001Z" fill="currentColor"/>
    <path fillRule="evenodd" clipRule="evenodd" d="M142.9 41.5001L141.3 34.1001H119.7V121.6H144.7V62.3001C150.6 54.6001 160.6 56.0001 163.7 57.1001V34.1001C160.5 32.9001 148.8 30.7001 142.9 41.5001Z" fill="currentColor"/>
    <path fillRule="evenodd" clipRule="evenodd" d="M92.8999 12.4001L68.4999 17.6001L68.3999 97.7001C68.3999 112.5 79.4999 123.4 94.2999 123.4C102.5 123.4 108.5 121.9 111.8 120.1V99.8001C108.6 101.1 92.7999 105.7 92.7999 90.9001V55.4001H111.8V34.1002H92.7999L92.8999 12.4001Z" fill="currentColor"/>
...
const CoinbasePay = ({ ...props }) => (
  <svg {...props} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
    viewBox="0 0 1101.64 196.79" style={{ enableBackground: 'new 0 0 1101.64 196.79' } as React.CSSProperties} xmlSpace="preserve">
