...
const TokenPocket = ({ ...props }) => (
  <svg {...props} width="88px" height="88px" viewBox="0 0 88 88" version="1.1" xmlns="http://www.w3.org/2000/svg">
    <defs>
...
const Facebook = ({ ...props }) => (
  <svg viewBox="0 0 36 36" fill="#0866ff" height="36" width="36" {...props}>
