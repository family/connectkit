    ...
    <div className=" p-0 relative flex align-center justify-start w-full">
      ...
      <Button
        className={cn(
          ...
          !buttonPressed ? 'w-[100%]' : 'w-unset text-base-content bg-transparent pointer-events-none cursor-default'
        )}
        type="button"
        onClick={() => {
          setFocus('email')
      ...
      >
        <div className="w-full flex items-center justify-center relative">
          ...
          <span className={cn('transition-opacity duration-300', buttonPressed && 'opacity-0')}>
