  ...
  const tabs: TabType[] = [
    {
      ...
      component: (
        <UserProfileCard
          sampleGithubUrl="https://github.com/openfort-xyz/quickstarts/tree/main/react/supabase"
  ...
  return (
    ...
    >
      <Head
        ...
        subtitle="Example of integration of Openfort with Supabase Authentication"
      />
      {!isAuthenticated ? (
        <SupabaseAuthCard />
      ) : (
