const Injected = (
  ...
  >
    <rect width="32" height="32" fill="var(--body-background)" />
    <path
      d="M13.998 19.3965H16.8423V18.7861C16.8423 17.5898 17.2939 16.9429 18.8931 16.0151C20.5532 15.0264 21.481 13.7202 21.481 11.8647V11.8525C21.481 9.15479 19.2349 7.23828 15.9023 7.23828C12.2769 7.23828 10.3359 9.33789 10.2017 12.0723L10.1895 12.2065H13.0581L13.0703 12.0967C13.1802 10.7051 14.1689 9.72852 15.7437 9.72852C17.2695 9.72852 18.3071 10.6562 18.3071 11.9624V11.9746C18.3071 13.1709 17.7944 13.8301 16.2808 14.7456C14.5962 15.7344 13.9126 16.8452 13.998 18.542V19.3965ZM15.4629 25.1338C16.4517 25.1338 17.2329 24.377 17.2329 23.4126C17.2329 22.436 16.4517 21.6914 15.4629 21.6914C14.4741 21.6914 13.6807 22.436 13.6807 23.4126C13.6807 24.377 14.4741 25.1338 15.4629 25.1338Z"
      fill="var(--body-color)"
    />
  </svg>
);
